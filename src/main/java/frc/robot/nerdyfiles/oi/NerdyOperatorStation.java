...
public class NerdyOperatorStation extends Joystick {
  ...
  public JoystickButton  whiteButton  = new JoystickButton(this, 5);
  public JoystickButton  yellowButton = new JoystickButton(this, 6);
  public JoystickButton  blueButton   = new JoystickButton(this, 4);
  public JoystickButton  blackButton  = new JoystickButton(this, 3);

  public JoystickButton  clearSwitch  = new JoystickButton(this, 9);
  public JoystickButton  yellowSwitch = new JoystickButton(this, 8);
  public JoystickButton  blueSwitch   = new JoystickButton(this, 12);
  public JoystickButton  blackSwitch  = new JoystickButton(this, 11);
